window.DOUSOUKAI_BGM_DATA = {
  ...
  ARR: {
    ...
    bossa:{ name:'ボサノバ喫茶版', desc:'ガットギター・エレピ・フルートをイメージした、やわらかなボサノバ調。昭和の喫茶店のような、落ち着いた懐かしさとおしゃれな雰囲気です。', scene:'歓談・食事中・受付・リラックスした会場BGM', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_bossa_1.mp3',160],['テイク2','yasaka_jhs_bossa_2.mp3',163]], yasaka:[['テイク1','bossa_1.mp3',123],['テイク2','bossa_2.mp3',138]], yusai:[['テイク1','arisai_bossa_1.mp3',149],['テイク2','arisai_bossa_2.mp3',143]] } },
    ...
    harmonica_folk:{ name:'ハーモニカ＋ギターの郷愁フォーク版', desc:'ハーモニカとアコースティックギターを中心にした、素朴で温かなアレンジ。昔の通学路や学生時代の記憶を思い起こさせます。', scene:'写真スライド・閉会前・歓談・懐かしさを演出したい場面', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_harmonica_folk_1.mp3',170],['テイク2','yasaka_jhs_harmonica_folk_2.mp3',199]], yasaka:[['テイク1','harmonica_folk_1.mp3',146],['テイク2','harmonica_folk_2.mp3',134]], yusai:[['テイク1','arisai_harmonica_folk_1.mp3',125],['テイク2','arisai_harmonica_folk_2.mp3',164]] } },
    ...
    music_box:{ name:'オルゴール追憶版', desc:'ほぼオルゴールだけで校歌をたどる、繊細で儚いアレンジ。思い出箱を開くような質感で、静かな余韻と懐かしさを残します。', scene:'写真スライド・思い出映像・静かな締め・しんみり振り返る場面', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_music_box_1.mp3',107],['テイク2','yasaka_jhs_music_box_2.mp3',144]] } },

    full_orchestra:{ name:'フルオーケストラ式典版', desc:'校歌の旋律を壮麗なオーケストラで表現した、最も式典向きのアレンジ。堂々とした雰囲気で節目の場面にふさわしい曲調です。', scene:'開会・閉会・記念映像のクライマックス・集合写真・式典演出', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_full_orchestra_1.mp3',163],['テイク2','yasaka_jhs_full_orchestra_2.mp3',190]], yasaka:[['テイク1','full_orchestra_1.mp3',164],['テイク2','full_orchestra_2.mp3',149]], yusai:[['テイク1','arisai_full_orchestra_1.mp3',119],['テイク2','arisai_full_orchestra_2.mp3',117]] } },
    orchestra:{ name:'オーケストラ版', desc:'弦楽器・木管・金管を中心とした、広がりのあるオーケストラアレンジ。格式があり、記念行事らしい華やかさを演出できます。', scene:'開会前BGM・入場・記念映像・集合写真スライド・式典的な場面', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_orchestra_1.mp3',155],['テイク2','yasaka_jhs_orchestra_2.mp3',170]], yasaka:[['再生','orchestra_2.mp3',152]], yusai:[['テイク1','arisai_orchestra_1.mp3',160],['テイク2','arisai_orchestra_2.mp3',133]] } },
    woodwind:{ name:'木管五重奏版', desc:'フルート・オーボエ・クラリネット・ファゴット・ホルンをイメージした室内楽風アレンジ。上品で落ち着いた雰囲気です。', scene:'恩師紹介・写真スライド・受付・静かな歓談・式典前後のBGM', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_woodwind_1.mp3',141],['テイク2','yasaka_jhs_woodwind_2.mp3',135]], yasaka:[['テイク1','woodwind_1.mp3',209],['テイク2','woodwind_2.mp3',179]], yusai:[['テイク1','arisai_woodwind_1.mp3',144],['テイク2','arisai_woodwind_2.mp3',83]] } },
    closing_reprise:{ name:'閉会リプライズ版', desc:'同窓会の締めくくりに合う、穏やかで温かいアレンジ。感謝や再会の余韻を残しながら、やさしく会を締めます。', scene:'閉会・退場・エンドロール・最後の写真スライド', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_closing_reprise_1.mp3',154],['テイク2','yasaka_jhs_closing_reprise_2.mp3',205]], yasaka:[['テイク1','closing_reprise_1.mp3',154],['テイク2','closing_reprise_2.mp3',129]], yusai:[['テイク1','arisai_closing_reprise_1.mp3',108],['テイク2','arisai_closing_reprise_2.mp3',103]] } },

    swing:{ name:'軽いスウィング版', desc:'軽快なリズムとジャズ風の響きを取り入れた、明るく楽しいアレンジ。少し華やかな曲調です。', scene:'乾杯後・歓談後半・写真撮影・会場を明るくしたい場面', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_swing_1.mp3',163],['テイク2','yasaka_jhs_swing_2.mp3',163]], yasaka:[['テイク1','swing_1.mp3',162],['テイク2','swing_2.mp3',177]], yusai:[['テイク1','arisai_swing_1.mp3',212],['テイク2','arisai_swing_2.mp3',145]] } },
    showa_kayo:{ name:'昭和歌謡インスト版', desc:'サックス・エレピ・ストリングスをイメージした昭和歌謡風のインスト。懐かしいテレビ音楽やレコードのような雰囲気です。', scene:'歓談・余興・聴き比べ企画・昭和らしい懐かしさを演出したい場面', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_showa_kayo_1.mp3',149],['テイク2','yasaka_jhs_showa_kayo_2.mp3',175]], yasaka:[['テイク1','showa_kayo_1.mp3',164],['テイク2','showa_kayo_2.mp3',152]], yusai:[['テイク1','arisai_showa_kayo_1.mp3',97],['テイク2','arisai_showa_kayo_2.mp3',139]] } },

    balkan:{ name:'バルカン・ブラス祭り版', desc:'金管とクラリネットが勢いよく鳴り響く、東欧の祝祭バンド風アレンジ。校歌が一気に賑やかな余興に変わる、明るい変化球です。', scene:'余興・聴き比べ企画・会場をぱっと明るくしたい場面', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_balkan_1.mp3',130],['テイク2','yasaka_jhs_balkan_2.mp3',146]] } },
    andes:{ name:'アンデス高原フォルクローレ版', desc:'ケーナやパンフルート、弦楽器の素朴な響きで校歌を包んだアレンジ。山の風景を思わせる広がりと郷愁があり、印象に残ります。', scene:'余興・思い出語り・少し異国感のある演出', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_andes_1.mp3',150],['テイク2','yasaka_jhs_andes_2.mp3',155]] } },
    irish:{ name:'アイリッシュ・ケルティック版', desc:'フィドルや笛を思わせる軽快な響きで、校歌を村祭りのように明るくアレンジ。軽やかで親しみやすい遊び枠です。', scene:'余興・歓談中のアクセント・明るく軽快な場面', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_irish_1.mp3',167],['テイク2','yasaka_jhs_irish_2.mp3',179]] } },
    gamelan:{ name:'ジャワ・ガムラン珍祭版', desc:'金属打楽器の反復と余韻で校歌を不思議に彩る、ガムラン風アレンジ。静かなのに妙に耳に残る、変化球の余興です。', scene:'余興・聴き比べ企画・不思議で印象に残したい場面', schools:{ yasaka_jhs:[['テイク1','yasaka_jhs_gamelan_1.mp3',148],['テイク2','yasaka_jhs_gamelan_2.mp3',128]] } },
  ...
  GROUPS: [
    ...
    { id:'memory', ico:'📷', title:'写真スライド・思い出映像', sub:'しっとり懐かしく、感動的な場面に', items:['strings_piano','yasaka_jhs_strings_piano','harmonica_folk','humming','music_box'] },
  ...
  BONUS_BY_SCHOOL: {
    yasaka_jhs:['balkan','andes','irish','gamelan'],
